...
public class AgentSettingsActivity extends AppCompatPreferenceActivity{
    ...
    private static void bindPreferenceSummaryToValue(Preference preference) {
        ...
        Object value = preference instanceof EditTextPreference ? preferences.getString(preference.getKey(), "") :
    ...
    protected boolean isValidFragment(String fragmentName) {
        return PreferenceFragment.class.getName().equals(fragmentName)
                ...
                || ThresholdPreferenceFragment.class.getName().equals(fragmentName);
    }
    ...
    public static class ServerPreferenceFragment extends PreferenceFragment  {
        ...
        public void onCreate(Bundle savedInstanceState) {
            ...
            // guidelines.
            bindPreferenceSummaryToValue(findPreference(getString(R.string.enable_upload)));
        ...
        public boolean onOptionsItemSelected(MenuItem item) {
            ...
            if (id == android.R.id.home) {
                startActivity(new Intent(getActivity(), AgentSettingsActivity.class));
                return true;
            }
     ...
     */
    @TargetApi(Build.VERSION_CODES.HONEYCOMB)
    public static class ThresholdPreferenceFragment extends PreferenceFragment {
        @Override
        public void onCreate(Bundle savedInstanceState) {
            super.onCreate(savedInstanceState);
            addPreferencesFromResource(R.xml.pref_thresholds);
            setHasOptionsMenu(true);
            ...
            bindPreferenceSummaryToValue(findPreference(getString(R.string.pref_key_viscosity)));
            bindPreferenceSummaryToValue(findPreference(getString(R.string.pref_key_humidity)));
        }
